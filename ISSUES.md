...
- ⏳ **US-407** : En tant que backend, je veux un serveur HTTP Axum ou Actix-Web
...
- ⏳ **US-428** : En tant que backend, je veux un WebSocket server (tokio-tungstenite ou Axum WS)
...
- ⏳ **US-445** : En tant que système, je veux persister les intents dans une DB (PostgreSQL)
...
- ⏳ **US-450** : En tant qu'infra, je veux un `PostgresAdapter` implémentant `StoragePort`
