    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">Verify zero-knowledge proofs generated by the protocol.</p>
        </div>
      </motion.div>
                ...
                >
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-heading text-lg font-bold capitalize">{proof.type} Proof</p>
                        <p className="text-sm text-muted-foreground">{proof.verifier} · {proof.constraints} constraints · {proof.proofTime}s generation</p>
                      </div>
                    </div>
                    ...
                    {isExpanded && (
                      ...
                      >
                        <div className="mt-4 rounded-lg border border-border/60 bg-secondary p-4 text-xs text-muted-foreground">
                          <p><strong>Verifier:</strong> {proof.verifier}</p>
                          <p className="mt-1"><strong>Constraints:</strong> {proof.constraints.toLocaleString()}</p>
                          <p className="mt-1"><strong>Proof generation time:</strong> {proof.proofTime}s</p>
                          {proof.txHash && <p className="mt-1"><strong>Tx hash:</strong> {proof.txHash}</p>}
